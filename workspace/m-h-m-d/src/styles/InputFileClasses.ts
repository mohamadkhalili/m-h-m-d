export const inputFileClasses = {
    ...
    labelClass: 'block mb-2 text-sm font-medium text-gray-900 dark:text-white cursor-pointer',
    uploadInnerClass: 'flex flex-col items-center justify-center p-8 border-4 border-dashed border-gray-500/20 rounded-xl bg-gray-500/10 hover:bg-gray-500/20 cursor-pointer transition-all duration-300 w-full', 
