...
export const sliderClasses = {
    ...
    trackBackground: {
      ...
      inside: 'absolute top-1/2 left-0 w-full h-8 rounded-full transform -translate-y-1/2'
    },
    trackFilled: {
        default: 'absolute top-1/2 left-0 h-2 rounded transform -translate-y-1/2',
        inside: 'absolute top-1/2 left-0 h-8 rounded-full transform -translate-y-1/2'
      },
