export const sliderClasses = {
  ...
  trackBackground: 'absolute top-1/2 left-0 w-full h-2 rounded transform -translate-y-1/2',
  trackFilled: 'absolute top-1/2 left-0 h-2 rounded transform -translate-y-1/2',
