...
<template>
  ...
  :class="[
    ...
    props.variant === 'shadow' && activeTab === tab.value ? 'shadow-inner transition-all duration-300 active:scale-95 rounded-lg' : '',
    props.variant === 'shadow' && activeTab !== tab.value ? 'shadow-sm transition-all duration-300 rounded-lg active:scale-95' : '',
