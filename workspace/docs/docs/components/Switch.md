...
<h7 class="text-xs">Disable in deActive side</h7>
<h7 class="text-xs">Disable in Active side</h7>
<Switch v-model="labelActive2" :isDisabled="true" activeColor="bg-cyan-500" inactiveColor="bg-cyan-950"/>
<Switch v-model="ColorActive1" :isDisabled="true" activeColor="bg-pink-500" inactiveColor="bg-pink-950"/>
</div>
</template>
